...
# ===================== PATHS =====================
listtitle = ["your launcher, your minecraft","welcome player","created by maxim, designer sprex_19","a program for linux","Have a nice game!","dssigner s"]
...
class LauncherApp(tk.Tk):
    def __init__(self):
        ...
        self.title(f"UMCL - {windowtitle} | 1.0.2 BETA-3")
