...
if minor <= 11:
    print("WARNING: This Python version is too old.")
elif minor == 15:
    print("WARNING: Python 3.15 — this version is very new, stability may be reduced.")
elif minor == 16:
    print("WARNING: Python 3.16 — this version is extremely new and may be unstable. Support may be limited.")
else:
    pass
listtitle = ["your launcher, your minecraft","welcome player","created by maxim, designer sprex_19","a program for linux","Have a nice game!"]
windowtitle = random.choice(listtitle)
HOME = os.path.expanduser("~")
LAUNCHER_DIR = os.path.join(HOME, ".UMCLLauncher")
...
class LauncherApp(tk.Tk):
    def __init__(self):
        ...
        self.title(f"UMCL - {windowtitle} | 1.0.2 release | PYTHON {major}.{minor}")
        ...
        if messagebox.askquestion("support UMCL","If you enjoy using the launcher, you can visit the project's GitHub page and support its development.") == "yes":
            ...
            webbrowser.open("https://github.com/makskolodiy/UMCL_linux")
    ...
    def build_ui(self):
        ...
        tk.Button(f3, text="telegram support", command=self.telegram, bg="#6e9ffc", fg="white").pack(side="left", padx=10)
        # Progress
    ...
    def problem(self):
        webbrowser.open("https://github.com/makskolodiy/UMCL_linux/issues/1")
        notification.notify(
            title="UMCL, report of bug",
            message="Please report this bug on our GitHub page. Thank you for helping improve MKLauncher!",
            timeout=8
        )
    def telegram(self):
        webbrowser.open("https://t.me/UMCL_Support_group")
    def guthub(self):
        messagebox.showinfo("thank you","Thank you for supporting the development of MKLauncher! We truly appreciate your support. Feel free to share your ideas and suggestions for features you'd like to see added to the launcher.")
        webbrowser.open("https://github.com/makskolodiy/UMCL_linux/")
...
class Mkiller(tk.Toplevel):
    def __init__(self, parent):
        ...
        button.pack(pady=20)
    def on_close(self):
        messagebox.showinfo("UMCL", "this window no closable")
    def kill(self):
